...
//Nome do Site
$core_nome     = "Faz e Acontese";
//Descrição do Site
$core_desc     ="Cerimonial e Eventos";
//Palavras-Chaves sobre o site, use virgulas para separa-las
$core_keywords ="cerimonial, eventos, belém, pará"; 
//Pasta do projeto
$core_pasta    ="faz-e-acontece";
//E-mail para recebimento das mensagens via site
$core_email    ="web@talentodesign.com.br"; 
